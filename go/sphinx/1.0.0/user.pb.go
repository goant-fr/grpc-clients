...
func (x *PersonalInformation) GetVerified() bool {
	if x != nil {
		return x.Verified
	}
	return false
...
const file_user_proto_rawDesc = "" +
	...
	"\bverified\x18\x06 \x01(\bR\bverified\"\xc8\x01\n" +
	"\x13PersonalInformation\x12%\n" +
	"\blastname\x18\x01 \x01(\tB\t\xbaH\x06r\x04\x10\x02\x182R\blastname\x12'\n" +
	"\tfirstname\x18\x02 \x01(\tB\t\xbaH\x06r\x04\x10\x02\x182R\tfirstname\x12\x1b\n" +
	"\x04mail\x18\x03 \x01(\tB\a\xbaH\x04r\x02`\x01R\x04mail\x12(\n" +
	"\x05phone\x18\x04 \x01(\tB\x12\xbaH\x0fr\r2\v^[0-9]{10}$R\x05phone\x12\x1a\n" +
	"\bverified\x18\x05 \x01(\bR\bverified\"\xe8\x01\n" +
