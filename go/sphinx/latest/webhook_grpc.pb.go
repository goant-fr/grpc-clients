...
const (
	WebhookService_HandleStripeWebhook_FullMethodName = "/sphinx.user.WebhookService/HandleStripeWebhook"
)
...
func (c *webhookServiceClient) HandleStripeWebhook(ctx context.Context, in *StripeWebhookRequest, opts ...grpc.CallOption) (*StripeWebhookResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StripeWebhookResponse)
	err := c.cc.Invoke(ctx, WebhookService_HandleStripeWebhook_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedWebhookServiceServer) HandleStripeWebhook(context.Context, *StripeWebhookRequest) (*StripeWebhookResponse, error) {
...
func _WebhookService_HandleStripeWebhook_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StripeWebhookRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WebhookServiceServer).HandleStripeWebhook(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: WebhookService_HandleStripeWebhook_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WebhookServiceServer).HandleStripeWebhook(ctx, req.(*StripeWebhookRequest))
	}
...
var WebhookService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sphinx.user.WebhookService",
	HandlerType: (*WebhookServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "HandleStripeWebhook",
			Handler:    _WebhookService_HandleStripeWebhook_Handler,
		},
	},
